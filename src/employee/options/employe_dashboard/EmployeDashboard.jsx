      ...
      <div className=" lg:grid-cols-3 grid  gap-4">
        ...
        <div className="bg-white w-full overflow-y-auto h-[310px] scrollbar-custom text-[#2A546D] rounded-lg p-4 md:p-6 shadow-md">
          <div className="flex justify-between items-center">
            <h2 className="text-[24px] font-semibold text-[#000000]">Important</h2>
            <a
              href="#"
          ...
          <div className="flex justify-between items-center mt-2">
            <div className="flex items-center">
              <span
                ...
                className={`cursor-pointer text-[#000000] font-semibold text-[14px] md:text-[16px] border-b-2 pb-1 ${activeTab === 'notification' ? 'border-[#000000]' : 'border-transparent'}`}
              >
                Notification
              </span>
            </div>
            <span
              ...
              className={`cursor-pointer flex items-center text-secondary text-[14px] md:text-[16px] ${activeTab === 'schedules' ? 'border-b-2 border-[#000000]' : 'border-transparent'}`}
            >
            ...
            <div className="flex flex-grow px-2 md:px-4">
              <div className="flex flex-col justify-between pr-2 md:pr-4 border-r border-gray-300">
                {[0, 5, 10, 15, 20, 25, 30, 35].map((hour) => (
                  <div className="text-gray-600 text-[8px] md:text-[10px] lg:text-xs" key={hour}>
                    {hour}
                  </div>
                ))}
              </div>
      ...
      <div className="rounded-lg shadow-lg w-auto mt-10 h-auto mx-auto lg:mx-0 px-4 lg:px-0">
        ...
        >
          ...
          <p className="text-white font-normal text-sm md:text-base">
            We are really proud of the difference you have made which gives everybody
