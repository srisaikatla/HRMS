  ...
  const renderDays = () => {
    ...
    for (let i = 0; i < startDay; i++) {
      daysArray.push(
        <div
          key={`empty-${i}`}
          className="day empty text-lg font-semibold"
        ></div>
      );
    }
              ...
              <tr key={event.id} className="bg-[#E65F2B] bg-opacity-20">
                ...
                <td className="py-2 px-4 border-b bg-transparent text-center border-r-0 border-[#E65F2B] border-opacity-80">
                  <div className="flex justify-center items-center space-x-2">
                    ...
                    >
                      <FiTrash2
                        className="mr-1 text-lg font-semibold bg-[#FF3636] text-white flex items-center size-6 p-1 rounded-md"
      ...
      {isDeleteModalOpen && (
        <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
          <div className="bg-white rounded-lg p-10 w-[400px] flex flex-col items-center justify-center">
            ...
            <p className="text-[#E65F2B] text-lg font-semibold">
