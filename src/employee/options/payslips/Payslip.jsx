...
//                   <span className="block text-[16px]">SDT0026</span>
//                 </div>
//                 <div className=" m-4 w-[150px] text-sm">
//                   <span className="block text-gray-500">Date Joined</span>
//                   <span className="block  text-[16px]">17-OCT-2023</span>
//                 </div>
...
//                   <span className="block  text-[16px]">N/A</span>
//                 </div>
//               </div>
...
//                   <span className="block text-[16px]">HR-EXECUTIVE</span>
//                 </div>
//                 <div className="w-[150px] m-4 text-sm">
//                   <span className="block text-gray-500">Payment Mode</span>
//                   <span className="block  text-[16px]">Bank Transfer</span>
//                 </div>
//                 <div className="w-[150px] m-4 text-sm">
...
//                 </div>
//                 <div className=" w-[150px] m-4 text-sm">
//                   <span className="block text-gray-500">Bank IFSC</span>
//                   <span className="block  text-[16px]">HDFC0001234</span>
//                 </div>
//               </div>
...
//                   <span className="block text-[16px]">7788789898998</span>
//                 </div>
//                 <div className="w-[150px] m-4 text-sm">
//                   <span className="block text-gray-500">PAN</span>
//                   <span className="block  text-[16px]">WEIRIR0982F</span>
//                 </div>
//                 <div className="w-[150px] m-4 text-sm">
...
//                     ACTUAL PAYABLE DAYS
//                   </span>
//                   <span className="block text-[16px]">31.0</span>
//                 </div>
//                 <div className="w-[150px] m-4 text-sm">
//                   <span className="block text-gray-500">
//                     TOTAL WORKING DAYS
...
//                   <span className="block  text-[16px] text-wrap">0.0</span>
//                 </div>
//                 <div className=" w-[150px] m-4 text-sm">
...
//             <div
//               id="main"
//               className=" w-auto h-auto grid-cols-2 grid mt-2 pb-2"
//             >
//               <div
//                 id="earnings"
//                 className=" h-auto border-r-4 border-gray-200 "
//               >
//                 <span className="text-xl">EARNINGS</span>
//                 <div id="submain" className="text-gray-700">
//                   <div className="text-[16px]  justify-between flex items-center pr-4">
//                     <span>Basic </span>
//                     <span>13,500.00</span>
//                   </div>
//                   <div className="text-[16px] justify-between flex items-center pr-4">
