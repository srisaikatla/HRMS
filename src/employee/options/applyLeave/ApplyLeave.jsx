    ...
    <div className="max-w-full mx-auto overflow-hidden p-4">
      ...
      <div className="flex flex-wrap justify-around  text-white gap-4 pt-10">
        {['Earned Leave', 'Sick Leave', 'Casual Leave'].map((type, i) => (
          <div
            key={i}
            className={`py-6 text-lg  px-4 rounded-lg lg:w-[380px] w-full font-semibold min-h-[200px] flex pl-4 flex-col ${
              type === 'Earned Leave'
                ? 'bg-[#FA1A8E]'
                : type === 'Sick Leave'
                ? 'bg-[#04B440]'
          ...
          >
           ...
           <span className="ml-4 text-white">{LeaveCount.remainingLeave}</span>
        </li>
            </ul>
          </div>
        ))}
            ...
            <tbody>
              {Leaves.map((leave) => (
                <tr key={leave.id} className="hover:bg-gray-100">
                  ...
                  <td className="px-4 py-3 border">{leave.startdate}</td>
                  <td className="px-4 py-3 border">{leave.enddate}</td>
                  <td className="px-4 py-3 border">{leave.selecthalf}</td>
