          ...
          {loading ? (
            ...
            <table className="min-w-full">
              <thead className="bg-[#2A546D] text-white">
                <tr>
                  <th className="py-4 px-4 text-center border-r border-white border-opacity-60 text-lg font-semibold">
                    Sl.No
                  </th>
                  <th className="py-4 px-4 text-center border-r border-white border-opacity-60 text-lg font-semibold">
                    Day
              ...
              <tbody>
                {holidays.map((holiday, index) => (
                  <tr key={holiday.holidayName}>
                    <td className="py-2 px-4 border-b bg-transparent text-center border-r border-[#2A546D] border-opacity-80 text-lg font-semibold">
                      {index + 1}
                    </td>
                    <td className="py-2 px-4 border-b bg-transparent text-center border-r border-[#2A546D] border-opacity-80 text-lg font-semibold">
                      {holiday.day}
