    ...
    <div className="md:my-5 py-3">
      <div className="flex justify-between items-center mb-7">
        <div className="flex gap-x-2">
          <h3 className="lg:text-lg font-semibold text-[#E65F2B]">Allowances</h3>
          <button
            type="button"
        ...
        <table className="min-w-full w-screen overflow-x-scroll text-nowrap">
          ...
          <tbody>
            {currentRecords.map((value) => (
              <tr
                key={value.id}
                className="bg-[#E65F2B] bg-opacity-20 md:text-lg font-normal"
              >
      ...
      {showModal && (
        <div className="fixed inset-0 flex items-center justify-center z-50 bg-blue-100 bg-opacity-50 text-lg font-normal">
          <div className="bg-white rounded-lg p-6 md:px-10 md:w-[700px] ">
            <h2 className="md:text-2xl mb-2 md:mb-4 text-[#E65F2B]">
            ...
            <div className="grid grid-cols-1 md:space-y-4 space-y-2">
              <div className="relative text-[#E65F2B]">
                <input
                  ...
                  className="block w-full border border-[#E65F2B] placeholder-[#E65F2B] rounded-md focus:outline-none md:p-2 p-1 placeholder-opacity-60"
                />
              </div>
              <div className="relative text-[#E65F2B]">
                <input
              ...
              <div className="relative text-[#E65F2B] flex space-x-11">
              ...
              <div className="relative text-[#E65F2B] flex space-x-[57px]">
              ...
              <div className="relative text-[#E65F2B] flex space-x-[51px]">
              ...
              <div className="relative text-[#E65F2B] flex space-x-[55px]">
      ...
      {isDeleteModalOpen && (
        <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
          <div className="bg-white rounded-lg p-6">
            <h2 className="text-xl mb-4 text-[#E65F2B] font-semibold">Confirm Deletion</h2>
