    ...
    <div className="flex flex-col flex-grow p-4">
      ...
      <div className="flex flex-wrap justify-center gap-4">
        {logos.map((logo) => (
          <div
            key={logo.id}
            className="flex items-center justify-center p-2 rounded-md shadow-sm"
        ...
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-lg shadow-lg w-auto max-w-md">
            ...
            <div className="mb-4 flex items-center w-auto gap-4">
              <label className="text-lg font-medium text-[#E65F2B] w-auto">
                Upload Logo
              </label>
              <input
                type="file"
            ...
            {isCropping && image && (
              <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center z-50">
                <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
                  <h3 className="text-xl mb-4 text-[#E65F2B]">
                    Crop Your Logo
                  </h3>
                  <div
                    className="relative"
