...
function HrRequestNotification() {
  ...
  const logActivity = (action) => {
    ...
    let activityLog =
      JSON.parse(localStorage.getItem("activityLogHrRequest")) || [];
    activityLog.push(activity);
    localStorage.setItem("activityLogHrRequest", JSON.stringify(activityLog));
  };

  return (
    // <div className="ml-20 mt-4 mx-auto p-5 text-[#e65f2b] gap-y-10">
...
export default HrRequestNotification;
