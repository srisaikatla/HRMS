...
function User() {
    ...
    return (
        <div className="p-4 sm:p-6 md:p-10">
            <div className='flex flex-col md:flex-row mb-5 text-lg'>
                <h1 
                    className={`font-bold mb-2 md:mb-0 md:mr-[40px] cursor-pointer px-4 py-2 rounded ${activeSection === 'users' ? 'bg-[#E65F2B]  text-white text-lg' : 'text-[#E65F2B]'}`} 
                    onClick={() => handleSectionChange('users')}
                >
                    Users
                </h1>
            ...
            {activeSection === 'users' && (
                <div id="table-users" className="overflow-x-scroll text-lg scrollbar-thin scrollbar-track-white scrollbar-thumb-orange-600 pt-10 mx-4">
                    ...
                    <table className="min-w-full md:w-auto w-full text-nowrap">
                        <thead className="bg-[#E65F2B] text-lg text-white sticky top-0 z-10">
                            <tr>
                                <th className="py-4 px-4 md:px-12 text-center border-r border-white border-opacity-60">UserName</th>
                                <th className="py-4 px-4 md:px-12 text-center border-r border-white border-opacity-60">Email Address</th>
                                <th className="py-4 px-4 md:px-12 text-center border-r border-white border-opacity-60">User Type (Role)</th>
                                <th className="py-4 px-4 md:px-12 text-center border-r border-white border-opacity-60">User Since</th>
                                <th className="py-4 px-4 md:px-12 text-center border-r border-white border-opacity-60">Employee</th>
                                <th className="py-4 px-4 md:px-14 text-center">Login</th>
                                <th className="py-4 px-4 md:px-12 text-center border-r border-white border-opacity-60">Status</th>
                            </tr>
                        </thead>
                        <tbody>
                            {filteredUsers.map((user, index) => (
                                <tr key={index}>
                                    <td className="py-4 px-4 md:px-12 text-center text-[#E65F2B] border-r border-gray-300">{user.name}</td>
                                    <td className="py-4 px-4 md:px-12 text-center text-[#E65F2B] border-r border-gray-300">{user.email}</td>
                                    <td className="py-4 px-4 md:px-12 text-center text-[#E65F2B] border-r border-gray-300">
                                        {user.role}
                                        <button onClick={() => handleEditClick(user)} className="ml-2 text-[#E65F2B]">
                                            <FaPen />
                                        </button>
                                    </td>
                                    <td className="py-4 px-4 md:px-12 text-center text-[#E65F2B] border-r border-gray-300">{user.joined}</td>
                                    <td className="py-4 px-4 md:px-12 text-center text-[#E65F2B] border-r border-gray-300">{user.employee}</td>
                                    <td className="py-4 px-4 md:px-14 text-center text-[#E65F2B]">N/A</td>
                                    <td className="py-4 px-4 md:px-12 text-center text-[#E65F2B] border-r border-gray-300">{user.status}</td>
                                </tr>
                            ))}
                        </tbody>
                    </table> 
                    ...
                    {editingRole && (
                        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50 p-4 sm:p-6">
                            <div className="bg-white w-full max-w-lg p-6 rounded-lg shadow-lg">
                                <h2 className="text-lg mt-4 text-[#E65F2B] font-semibold mb-4">Edit Role for {editingRole.name}</h2>
                                <label className="block mb-2">
            ...
            {activeSection === 'invites' && (
                <div className="pt-10 mx-4 text-lg">
                    ...
                    <table className="min-w-full text-lg text-[#E65F2B]">
                        <thead className="bg-[#E65F2B] text-white">
                            <tr>
                                <th className="py-4 px-4 md:px-12 text-center">Email Address</th>
                                <th className="py-4 px-4 md:px-12 text-center">Role</th>
                                <th className="py-4 px-4 md:px-12 text-center">Employee</th>
                                <th className="py-4 px-4 md:px-12 text-center">Sent By</th>
                                <th className="py-4 px-4 md:px-12 text-center">Sent On</th>
                                <th className="py-4 px-4 md:px-14 text-center">Status</th>
                                <th className="py-4 px-4 md:px-14 text-center">Action</th>
                            </tr>
                        </thead>
                        <tbody>
                            {invites.map((invite, index) => (
                                <tr key={index}>
                                    <td className="py-4 px-4 md:px-12 text-center text-[#E65F2B]">{invite.email}</td>
                                    <td className="py-4 px-4 md:px-12 text-center text-[#E65F2B]">{invite.role}</td>
                                    <td className="py-4 px-4 md:px-12 text-center text-[#E65F2B]">{invite.employee}</td>
                                    <td className="py-4 px-4 md:px-12 text-center text-[#E65F2B]">{invite.sentBy}</td>
                                    <td className="py-4 px-4 md:px-12 text-center text-[#E65F2B]">{invite.sentOn}</td>
                                    <td className="py-4 px-4 md:px-14 text-center text-[#E65F2B]">{invite.status}</td>
                                    <td className="py-4 px-4 md:px-14 text-center text-[#E65F2B]">{invite.action}</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
                    ...
                    {isModalOpen && (
                        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50 p-4 sm:p-6">
                            <div className="bg-white w-full max-w-lg p-6 rounded-lg shadow-lg">
                                <h2 className="text-lg text-[#E65F2B] font-semibold mb-4">Add New Invite</h2>
                                <form onSubmit={handleFormSubmit}>
                                    <label className="block mb-2">
                                        <span className="text-[#E65F2B] font-semibold">Employee</span>
                                        <input 
                                            id="employee"
                                            value={formData.employee}
                                            onChange={handleInputChange}
                                    ...
                                    <label className="block mb-2">
                                        <span className="text-[#E65F2B] font-semibold">Email</span>
                                        <input 
                                            id="email"
                                            value={formData.email}
                                            onChange={handleInputChange}
