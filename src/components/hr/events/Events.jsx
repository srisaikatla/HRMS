        ...
        <div className=" h-screen">
          ...
          <p className="text-[#e65f2b] font-bold text-lg">Events</p>
            ...
            <div className="flex justify-end mb-4">
                ...
                >
                    <FaPlusCircle className="text-white text-3xl mr-2" />
                    <span className="text-white font-medium text-lg">Add new Events</span>
                </button>
            </div>
            ...
            <thead style={{ background: "rgba(0, 152, 241, 0.1)" }}>
              <tr>
                ...
                <th className="py-4   border-b bg-[#0098f1] bg-opacity-30 text-center">Event Name</th>
            ...
            <tbody>
              {Events.map((Event) => ( 
                <tr key={Event.id}>
                  <td className="py-2 px-4 border-b bg-transparent text-center">{Event.day}</td>
                  <td className="py-2 px-4 border-b bg-transparent text-center">{Event.date}</td>
                  <td className="py-2 px-4 border-b bg-transparent text-center ">{Event.name}</td>
                  <td className="py-2 px-4 border-b bg-transparent text-center">
                    <div className="flex justify-center space-x-2">
                      <button className="text-blue-500 flex py-3 items-center" onClick={() => openEditModal(Event.id)}>
                        <FiEdit className="mr-1 bg-[#2A8F4C] text-white rounded-md size-6 p-1" />
                      </button>
                      <button className="flex  items-center justify-center" onClick={() => handleDeleteEvent(Event.id)}>
