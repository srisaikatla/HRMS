...
//         <div
//           className="w-48 h-48 bg-[#0098f1] relative flex  justify-center items-center"
//           style={{ clipPath: "polygon(50% 0, 100% 50%, 50% 100%, 0% 50%)" }}
//         >
//           <span className="absolute top-1/2 shadow-gray-600 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full h-[3px] bg-white shadow-2xl"></span>
//           <span className="absolute top-1/2 shadow-gray-600 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full h-[3px] bg-white shadow-2xl rotate-90"></span>
//         </div>
//       </div>
//     </>
//   );
